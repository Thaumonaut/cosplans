...
>
  ...
  >
    ...
    <p class="mt-4 text-base text-slate-600">
      The marketing site is under construction. Developers can access the tools dashboard below.
    </p>
    <a
      href="/dev"
      class="mt-6 inline-flex items-center gap-2 rounded-full bg-blue-600 px-5 py-2 font-semibold text-white shadow transition hover:bg-blue-700"
    >
