...
export const THEME_VARIANTS: ThemeVariant[] = [
	...
	},
	{
		...
		cssVars: {
			...
			'--theme-background-pattern': 'radial-gradient(circle at 20% 50%, rgba(25, 218, 90, 0.15) 0%, transparent 50%), radial-gradient(circle at 80% 20%, rgba(33, 249, 106, 0.12) 0%, transparent 50%), radial-gradient(circle at 50% 80%, rgba(25, 218, 90, 0.1) 0%, transparent 50%), radial-gradient(circle at 40% 30%, rgba(33, 249, 106, 0.08) 0%, transparent 40%)',
			...
			'--theme-active': '#19DA5A',
			'--theme-focus': '#21F96A',
			'--theme-primary': '#19DA5A',
			'--theme-primary-hover': '#16A34A',
			'--theme-accent': '#21F96A',
			'--theme-accent-hover': '#19DA5A',
			'--theme-success': '#19DA5A',
			'--theme-error': '#ef4444',
			'--theme-warning': '#f59e0b',
			'--theme-info': '#3b82f6'
		},
