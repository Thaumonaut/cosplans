...
{:else}
	...
	<div class="relative w-full" data-team-dropdown>
		...
		>
			<div class="flex h-8 w-8 items-center justify-center rounded-lg bg-blue-100 text-blue-700 flex-shrink-0">
			...
			>
				{#each teams as team (team.id)}
					<button
						...
						style={team.isActive ? 'color: var(--theme-sidebar-accent);' : 'color: var(--theme-foreground);'}
