...
1. **Setup**: Run the appropriate setup script from repo root based on OS:
   - **Windows**: `.specify/scripts/powershell/setup-plan.ps1 -Json`
   - **Unix/Mac**: `.specify/scripts/bash/setup-plan.sh --json`
...
3. **Agent context update**:
   - Run the appropriate update script based on OS:
     - **Windows**: `.specify/scripts/powershell/update-agent-context.ps1 copilot`
     - **Unix/Mac**: `.specify/scripts/bash/update-agent-context.sh copilot`
